...
def train(modeltype, adaptertype, X_train, y_train, X_train_target, y_train_target, seed,
...
if __name__ == '__main__':
    ...
    # Run the experiment
    run_experiment(modeltype, adaptertype, n, trainsource, full_data_used, keep, X_train, X_test, y_train, y_test,
                   franklin, X_franklin_1920, y_franklin_1920, X_franklin_1931, y_franklin_1931,
                   colnames, num_cv_splits, seed,
                   n_estimators, max_depth, min_samples_split, min_samples_leaf, max_features,
                   alpha, ocr_threshold, comments)
