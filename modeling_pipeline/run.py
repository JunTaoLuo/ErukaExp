...
if __name__ == '__main__':
    ...
    if not args.regen_matrices:
        ...
        X_train_hand, X_train_ocr, X_test, X_train_hand_sub, X_train_ocr_sub, X_test_sub, y_train_hand, y_train_ocr, y_test, X_franklin_1920, X_franklin_1931, y_franklin_1920, y_franklin_1931, colnames, colnames_sub = utils.main(db_engine, keep=keep,
